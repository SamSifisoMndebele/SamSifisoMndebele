        ...
        <div className="row">
          ...
          <div className="col-lg-4">
            <div className="contact-info-card">
              ...
              <div className="row mb-2">
                <div className="col-1 pt-1 mr-1"><i className="fa-regular fa-envelope icon-md"></i></div>
                <div className="col-10">
              ...
              <ul className="social-icons pt-4">
                <li className="social-item">
                  <a href="https://github.com/SamSifisoMndebele" target="_blank" rel="noopener noreferrer" className="social-link text-dark">
                    <i className="fa-brands fa-github" aria-hidden="true"></i>
                  </a>
                </li>
                <li className="social-item">
                  <a href="https://www.facebook.com/sam.sifiso.mndebele" target="_blank" rel="noopener noreferrer" className="social-link text-dark">

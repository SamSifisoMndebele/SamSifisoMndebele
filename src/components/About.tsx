        ...
        <div className="col-lg-4 about-card">
          ...
          <ul className="social-icons pt-3">
            <li className="social-item">
              <a href="https://github.com/SamSifisoMndebele" target="_blank" rel="noopener noreferrer" className="social-link">
                <i className="fa-brands fa-github"></i>
              </a>
            </li>
            <li className="social-item">
              <a href="https://wa.me/27721646430?text=%3E%20From%20GitHub%0AHi%20Sam,%0A" target="_blank" rel="noopener noreferrer" className="social-link">
                <i className="fa-brands fa-whatsapp"></i>
              </a>
            </li>
            <li className="social-item">
              <a href="mailto:sams.mndebele@studentintellect.co.za" target="_blank" rel="noopener noreferrer" className="social-link">
                <i className="fa-regular fa-envelope"></i>
              </a>
            </li>
            <li className="social-item">
              <a href="https://www.facebook.com/sam.sifiso.mndebele" target="_blank" rel="noopener noreferrer" className="social-link">
                <i className="fa-brands fa-facebook-f"></i>
              </a>
            </li>
            <li className="social-item">
              <a href="https://www.instagram.com/sam.sifiso.mndebele" target="_blank" rel="noopener noreferrer" className="social-link">
        ...
        <div className="col-lg-4 about-card">
          ...
          <div className="row">
            ...
            <div className="col-10 ml-auto mr-3">
              ...
              <p className="subtitle">Building responsive and dynamic websites and robust Android applications with a focus on performance, usability, and seamless integration across devices.</p>
              <hr />
            </div>
          </div>
          <div className="row">
            ...
            <div className="col-10 ml-auto mr-3">
              ...
              <p className="subtitle">Implementing secure and efficient server-side logic, APIs, and databases.</p>
              <hr />
            </div>
          </div>
          <div className="row">
            ...
            <div className="col-10 ml-auto mr-3">
              <h6>Ecommerce</h6>
              <p className="subtitle">Initiating and developing ecommerce platforms that offer seamless shopping experiences, from product browsing to secure checkout, ensuring they meet user needs and industry standards.</p>
              <hr />
            </div>
          </div>
        </div>

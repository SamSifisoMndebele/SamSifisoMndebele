      ...
      <div className="container" id="header" style={{ maxWidth: '100vw' }}>
        <ul className="social-icons pt-3" style={{ paddingLeft: '32px' }}>
          <li className="social-item">
            <a href="https://github.com/SamSifisoMndebele" target="_blank" rel="noopener noreferrer" className="social-link text-light">
              <i className="fa-brands fa-github"></i>
            </a>
          </li>
          <li className="social-item">
            <a href="https://wa.me/27721646430?text=%3E%20From%20Portfolio%0AHi%20Sam,%0A" target="_blank" rel="noopener noreferrer" className="social-link text-light">
          ...
          <li className="social-item">
            <a href="https://www.facebook.com/sam.sifiso.mndebele" target="_blank" rel="noopener noreferrer" className="social-link text-light">
              <i className="fa-brands fa-facebook-f"></i>
            </a>
          </li>
          <li className="social-item">
            <a href="https://www.instagram.com/sam.sifiso.mndebele" target="_blank" rel="noopener noreferrer" className="social-link text-light">
